...
var _App = _interopRequireDefault(__webpack_require__(149));
...
*/
var aa=__webpack_require__(5),ba=__webpack_require__(1),m=__webpack_require__(141),p=__webpack_require__(4),v=__webpack_require__(7),da=__webpack_require__(142),ea=__webpack_require__(143),fa=__webpack_require__(144),ha=__webpack_require__(6);
...
var _reactHotLoader = __webpack_require__(150);

var _Scheduler = _interopRequireDefault(__webpack_require__(152));
...
var _REST = __webpack_require__(153);

var _stylesM = _interopRequireDefault(__webpack_require__(155));

var _instruments = __webpack_require__(10);

var _Checkbox = _interopRequireDefault(__webpack_require__(136));

var _index = _interopRequireDefault(__webpack_require__(164));

var _index2 = _interopRequireDefault(__webpack_require__(171));
...
class Scheduler extends _react.Component {
  constructor(...args) {
    ...
    _defineProperty(this, "_filterTask", () => {
      const {
        tasks,
        tasksFilter
      } = this.state;
    ...
    _defineProperty(this, "_fetchTasksAsync", async () => {
      try {
        ...
        this.setState({
          tasks: (0, _instruments.sortTasksByGroup)(tasks)
        });
      } catch ({
        message
      }) {
    ...
    _defineProperty(this, "_createTaskAsync", async event => {
      ...
      if (newTaskMessage) {
        try {
          ...
          const task = await _REST.api.createTask(newTaskMessage);
          this.setState(prevState => ({
            tasks: (0, _instruments.sortTasksByGroup)([task, ...prevState.tasks]),
            newTaskMessage: ''
          }));
        } catch ({
          message
    ...
    _defineProperty(this, "_updateTaskAsync", async taskToUpdate => {
      try {
        this._setTasksFetchingState(true);
        ...
        const updatedTask = await _REST.api.updateTask(taskToUpdate);
        const index = tasks.findIndex(task => task.id === taskToUpdate.id);
        const updatedTasks = tasks.map((task, id) => id === index ? updatedTask : task);
        const sortedUpdatedTasks = (0, _instruments.sortTasksByGroup)(updatedTasks);
        this.setState({
    ...
    _defineProperty(this, "_completeAllTasksAsync", async () => {
      ...
      if (incompleteTasks.length !== 0) {
        ...
        try {
          await _REST.api.completeAllTasks(incompleteTasks.map(task => {
            task.completed = true;
            return task;
          }));
          this.setState(({
...
const api = {
  ...
  async removeTask(id) {
    const response = await fetch(`${_config.MAIN_URL}/${id}`, {
      method: "DELETE",
      headers: {
        Authorization: _config.TOKEN
      }
  ...
  async completeAllTasks(tasks) {
    ...
    await Promise.all(tasksFetched).then(resolve => {
...
// extracted by mini-css-extract-plugin
module.exports = {"completeAllTasks":"styles-m__completeAllTasks---1-L3W","scheduler":"styles-m__scheduler---1OOpl"};
...
var _moment = _interopRequireDefault(__webpack_require__(0));

var _uuid = __webpack_require__(159);
...
var v1 = __webpack_require__(160);
...
var _classnames = _interopRequireDefault(__webpack_require__(165));

var _propTypes = _interopRequireDefault(__webpack_require__(3));

var _stylesM = _interopRequireDefault(__webpack_require__(166));

var _Checkbox = _interopRequireDefault(__webpack_require__(136));

var _Edit = _interopRequireDefault(__webpack_require__(168));

var _Remove = _interopRequireDefault(__webpack_require__(169));

var _Star = _interopRequireDefault(__webpack_require__(170));
...
class Task extends _react.PureComponent {
  constructor(...args) {
    ...
    _defineProperty(this, "_setTaskEditingState", isTaskEditing => {
  ...
  render() {
    ...
    return _react.default.createElement("li", {
      className: (0, _classnames.default)(_stylesM.default.task, {
...
_defineProperty(Task, "propTypes", {
  ...
  favorite: _propTypes.default.bool.isRequired,
  message: _propTypes.default.string.isRequired,
  _removeTaskAsync: _propTypes.default.func.isRequired,
  _updateTaskAsync: _propTypes.default.func.isRequired
});
...
// extracted by mini-css-extract-plugin
module.exports = {"actions":"styles-m__actions---GvF1H","completed":"styles-m__completed---2zA-y","content":"styles-m__content---1Y7YH","task":"styles-m__task---1_JYz","toggleTaskCompletedState":"styles-m__toggleTaskCompletedState---1rACg","toggleTaskFavoriteState":"styles-m__toggleTaskFavoriteState---31dz0","updateTaskMessageOnClick":"styles-m__updateTaskMessageOnClick---18642"};
...
var _stylesM = _interopRequireDefault(__webpack_require__(172));
...
_defineProperty(Spinner, "propTypes", {
  isSpinning: _propTypes.default.bool.isRequired
});
...
/***/ })
/******/ ]);
//# sourceMappingURL=source.2bf01.js.map